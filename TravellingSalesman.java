...
public class TravellingSalesman {
    ...
    static ArrayList<Integer> swap(ArrayList<Integer> data, int left, int right){
    ...
    static ArrayList<Integer> reverse(ArrayList<Integer> data, int left, int right){
        while (left < right){
            int temp = data.get(left);
            data.set(left++, data.get(right));
            data.set(right--, temp);
    ...
    public static void main(String args[]){
        ...
        System.out.println(travllingSalesmanProblem(grid, 0));
    }
}